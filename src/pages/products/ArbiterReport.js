...
const { heading, subheading, description, imageSrc, accomplishments } =
    projects["arbiter-report"];
// const { heading, subheading, description, description2, imageSrc, accomplishments } = projects['arbiter-report'];
    ...
    return (
        <AnimationRevealPage>
            ...
            <HeroProduct
                ...
                primaryButtonText="Get Demo"
                primaryButtonUrl="https://demo.simppl.org"
                imageSrc={imageSrc}
                imageCss={imageCss}
