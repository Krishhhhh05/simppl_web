...
// import FellowshipHero from "components/features/TwoColWithButtonAndSupportAndModal.js";
// // import FellowshipHero from "components/features/TwoColWithButtonAndSupport.js";
...
// const Heading = tw.span`text-3xl font-black tracking-wide text-center`;
// const Description = tw.span`mt-4 text-center text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary-100`;
...
//                 description={
//                     <>
//                         We're excited to announce the first Responsible AI
//                         Research program hosted by our research collective,
//                         called SimPPL, at DJ Sanghvi College of Engineering,
//                         Mumbai. This is a free program that will provide
//                         undergraduate students with computing research
//                         opportunities and mentorship through a 6-month long
//                         research training sponsored by Google Research, with
//                         certificates available for selected students. Alumni and
//                         mentors in this program come in with experience at top
//                         universities and companies including MIT, Oxford, NYU, X
//                         (Twitter), Goldman Sachs, Adobe, CERN, Bombora. We have
//                         developed award-winning tools like{" "}
//                         <a
//                             style={{
//                                 fontWeight: "600",
...
//                 buttonRounded={false}
//                 primaryButtonText="Resident Fellowships"
//                 imageSrc="/mockups/workshop-mock.png"
//                 primaryButtonStatus={true}
//                 primaryButtonUrl="/resident-fellowships"
//                 primaryDesc={
//                     <Description>
//                         Resident Fellows are students who are currently enrolled
//                         (and will remain enrolled until June 2024) in accredited
//                         educational programs within Shri Vile Parle Kelavani
//                         Mandal's education institutions including Mukesh Patel
//                         School of Technology Management and Engineering and
//                         Dwarkadas J. Sanghvi College of Engineering. These
//                         Fellows will receive curricular credit for pursuing
//                         elective projects related to responsible computing and
//                         topics will be selected jointly by the Fellows with
//                         guidance and participation by their college professors.{" "}
//                         <br></br>The structure of the fellowships for Resident
//                         Fellows will include in-person workshops training them
//                         to pursue responsible computing research. They will
//                         continue building group projects that complement their
//                         curricular activities with a study of topics in
//                         responsible computing related to online safety.
//                     </Description>
//                 }
//                 secondaryButtonUrl=""
//                 secondaryButtonStatus={true}
//                 secondaryButtonText="Non-Resident Fellowships"
//                 secondaryDesc={
//                     <Description>
//                         Non-Resident Fellows include undergraduate students from
//                         across the country who are not currently enrolled in
//                         accredited educational programs within Shri Vile Parle
//                         Kelavani Mandal's education institutions. These Fellows
//                         will receive curricular credit for pursuing elective
//                         projects related to responsible computing and topics
//                         will be selected independently by the Fellows with
//                         guidance from SimPPL program staff and mentors.{" "}
...
//                 fellowshipDetails={{
//                     resident: {
//                         title: <Heading>Resident Fellowships</Heading>,
//                         desc: (
//                             <Description>
//                                 Resident Fellows are students who are currently
//                                 enrolled (and will remain enrolled until June
//                                 2024) in accredited educational programs within
//                                 Shri Vile Parle Kelavani Mandal's education
//                                 institutions including Mukesh Patel School of
//                                 Technology Management and Engineering and
//                                 Dwarkadas J. Sanghvi College of Engineering.
//                                 These Fellows will receive curricular credit for
//                                 pursuing elective projects related to
//                                 responsible computing and topics will be
//                                 selected jointly by the Fellows with guidance
//                                 and participation by their college professors.{" "}
//                                 <br></br>The structure of the fellowships for
//                                 Resident Fellows will include in-person
//                                 workshops training them to pursue responsible
//                                 computing research. They will continue building
//                                 group projects that complement their curricular
//                                 activities with a study of topics in responsible
//                                 computing related to online safety.
//                             </Description>
//                         ),
//                     },
//                     nonResident: {
//                         title: <Heading>Non-Resident Fellowships</Heading>,
//                         desc: (
//                             <Description>
//                                 Non-Resident Fellows include undergraduate
//                                 students from across the country who are{" "}
//                                 <u>not</u> currently enrolled in accredited
//                                 educational programs within Shri Vile Parle
//                                 Kelavani Mandal's education institutions. These
//                                 Fellows will receive curricular credit for
//                                 pursuing elective projects related to
//                                 responsible computing and topics will be
//                                 selected independently by the Fellows with
//                                 guidance from SimPPL program staff and mentors.{" "}
//                                 <br></br> The structure of the fellowships for
//                                 Non-Resident Fellows will include in-person
//                                 workshops training them to pursue responsible
//                                 computing research. They will continue towards
//                                 building remote collaborations through group
//                                 projects that include a study of topics in
//                                 responsible computing related to online safety.
//                             </Description>
//                         ),
//                     },
                ...
                plans={[
                    ...
                    },
                    {
                        ...
                        features: [
                            "Registration Start: 20 Nov, 2023",
                            // "Registration End: 29 Nov 2023",
                            "Result Anouncement: Rolling till 31 Jan, 2024",
                            // "Event Day: 03 Dec 2023, 10AM IST onwards",
                            // "Venue: D.J. Sanghvi Engineering College, Mumbai",
                        ],
                        url: "https://forms.gle/EGrvYdgPQd9cvyyR7",
