...
import NewNewsPage from "pages/NewNews.js";
...
import FellowshipRenderer from "FellowshipRenderer.js";
    ...
    return (
        <Router>
            <Switch>
                ...
                {/* Route to see all the components on one page */}
                <Route path="/test">
                    <MainLandingPage />
                </Route>
                <Route path="/test3">
