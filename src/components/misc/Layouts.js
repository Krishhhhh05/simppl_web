...
export const ContentWithPadding2Xl = tw.div`max-w-screen-2xl mx-auto py-20 lg:py-24`;
export const ContentWithPaddingXl = tw.div`max-w-screen-xl mx-auto py-20 lg:py-24`;
export const ContentWithPaddingLg = tw.div`max-w-screen-lg mx-auto py-12 lg:py-16`;
